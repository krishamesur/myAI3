...
// If you want to use a Fireworks model, uncomment and set FIREWORKS_API_KEY in Vercel
...
export const AI_NAME = "Stock Unlock";
export const OWNER_NAME = "Krish Amesur";

// This is the FIRST static message shown in the UI (before any API call)
